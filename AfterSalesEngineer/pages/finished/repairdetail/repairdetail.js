// pages/finished/repairdetail/repairdetail.js
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.applyTime != null) {
          res.data.applyTime = that.timestampToTime(res.data.applyTime)
        }
        if (res.data.dealTime != null) {
          res.data.dealTime = that.timestampToTime(res.data.dealTime)
        }
