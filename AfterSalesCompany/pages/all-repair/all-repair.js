...
Page({
  ...
  clickSearch:function(){
    wx.navigateTo({
      url: '../all-repair/search/search',
    })
  },

  clickFilter: function () {
    wx.navigateTo({
      url: '../all-repair/filter/filter',
    })
  },

  clickInstall:function(){
    wx.navigateTo({
      url: './install-order/install-order',
    })
  },

  clickMaintain:function(){
    wx.navigateTo({
      url: './maintain-order/maintain-order',
    })
  },
  ...
  onShow: function () {
    ...
    var that = this;
    wx.request({
      url: "https://sh.jinhuan123.com/weixin/repair/list",
      method: "GET",
